...
if my_id.object_index = asset_get_index("obj" + other.prefix + "KillBlunt") {//objPKillBlunt {

//temporary fix for police enemies
...
//my_id.sprite_index=sprPKillNightStick
}
my_id.sprite_index = asset_get_index("spr" + other.prefix + "Kill" + scrWeaponList(7, sprite_get_name(objPlayer.sprite_index)))
...
if objPlayer.sprite_index=sprPWalkBat or objPlayer.sprite_index=sprPAttackBat {global.usedkill[2]=1 my_id.sprite_index=sprPKillBat}
if objPlayer.sprite_index=sprPWalkPipe or objPlayer.sprite_index=sprPAttackPipe {global.usedkill[1]=1 my_id.sprite_index=sprPKillPipe}
if objPlayer.sprite_index=sprPWalkClub or objPlayer.sprite_index=sprPAttackClub {global.usedkill[0]=1 my_id.sprite_index=sprPKillClub}
if objPlayer.sprite_index=sprPWalkBag or objPlayer.sprite_index=sprPAttackBag my_id.sprite_index=sprPKillBag
...
if my_id.object_index=objPKillDrill and sprite_index=sprPoliceGetUp {
