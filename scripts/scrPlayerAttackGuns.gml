...
if sprite_index=sprPWalkM16             {armlength=5    Shoot(sndM16,0.5,2,3,false,false,      sprM16Shell) }
if sprite_index=sprPWalkKalashnikov     {armlength=5    Shoot(sndKalashnikov,0.5,2,3,false,false,sprM16Shell) }
if sprite_index=sprPWalkShotgun         {armlength=5    ShootShotgun()                                      }
...
if sprite_index=sprPWalk9mm             {armlength=20   Shoot(snd9mm,0.5,10,2,false,false, sprUziShell)     }
